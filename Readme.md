...
```javascript
weather.now("Location",function(aData)
...
weather.now(["location1","location2"],function(datas)
//Location can be id, city name or coordinate ([lat,lon])
{
...
weather.forecast("Location",function(aData)
//Location can be id, city name or coordinate ([lat,lon])
{	
	//you can use weather 'object' aData
...
//if you give an array of location you get an array of weathers
weather.forecast(["location1","location2"],function(datas)
//Location can be id, city name or coordinate ([lat,lon])
{
	datas.forEach(function(aData)
	{
