(function() {
	...
	constructUrl = function(data,type)
	{
		switch(typeof(data))
		{
			case 'string' :
				return	"/data/2.5/" + type + (forecastType && type == "forecast" ? "/" + forecastType: "") + "?q=" + data+ "&lang=" + lang;
			break;
			case 'number' :
				return	"/data/2.5/" + type + (forecastType && type == "forecast" ? "/" + forecastType : "") + "?id=" + data+ "&lang=" + lang;
			break;
			case 'object' :
				return	"/data/2.5/" + type + (forecastType && type == "forecast" ? "/" + forecastType : "") + "?lat=" + data[0] + "&lon=" + data [1]+ "&lang=" + lang;
			break;
		}
	} 
